...
{
    /// <summary>
    ///     Drawers_total_charge test. Includes basecharge +200, NO surfacecharge
    ///     +50, mahoganywood +150, 2 drawers + 60.
    ///     Final cost is 410.
    /// </summary>
    [TestClass()]
    public class Exercise7ATestCase3
    {
        ...
        public void MyTestInitialize()
        {
            ...
            _systemUnderTest = new Exercise7A("Netta", 70, 10, 2, 123456, "mahogany");
        }
